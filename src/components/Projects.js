                        ...
                        projects.map((project) => (
                            <a href="{project.link}" key={project.image} className="sm:w-1/2 w-100 p-4">
                                <div className="flex relative">
                                    ...
                                    <div className="px-8 py-10 relative z-1 w-full border-4 border-gray-800 bg-gray-900 opacity-0 hover:opacity-100 transition-opacity duration-300 ease-in-out">
                                        <h2 className="tracking-widest text-sm title-font font-medium text-green-400 mb-1">{project.subtitle}</h2>
                                        <h1 className="title-font text-lg font-medium text-white mb-2">{project.title}</h1>
